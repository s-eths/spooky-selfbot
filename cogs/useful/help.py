...
class help(commands.Cog):
    ...
    async def on_message(self, message):
        if message.author.id in data["whitelisted"]:
            if message.content == f"{data['prefix']}help":
            ...
            elif message.content == f"{data['prefix']}help ai":
                await message.reply(f"**spooky.wtf - Discord Self-Bot**\n\n> **[!]** Help - AI\n\n`{data['prefix']}ocr [image]`\n\n-# Created by @ s.eths・v{data['version']}")
            elif message.content == f"{data['prefix']}help config":
                await message.reply(f"**spooky.wtf - Discord Self-Bot**\n\n> **[!]** Help - Configuration\n\n> **(ALL OWNER ONLY)**\n\n`{data['prefix']}setprefix [prefix]`\n`{data['prefix']}whitelist [user]`\n`{data['prefix']}unwhitelist [user]`\n`{data['prefix']}whitelisted`\n\n-# Created by @ s.eths・v{data['version']}")
            elif message.content == f"{data['prefix']}help crypto":
            ...
            elif message.content == f"{data['prefix']}help encode":
                await message.reply(f"**spooky.wtf - Discord Self-Bot**\n\n> **[!]** Help - Encode\n\n`{data['prefix']}decodeb64 [base64string]`\n\n-# Created by @ s.eths・v{data['version']}")
            elif message.content == f"{data['prefix']}help exploit":
            ...
            elif message.content == f"{data['prefix']}help fun":
            ...
            elif message.content == f"{data['prefix']}help image":
                await message.reply(f"**spooky.wtf - Discord Self-Bot**\n\n> **[!]** Help - Image\n\n`{data['prefix']}cat`\n`{data['prefix']}dog`\n`{data['prefix']}meme`\n`{data['prefix']}wanted [user]`\n\n-# Created by @ s.eths・v{data['version']}")
            elif message.content == f"{data['prefix']}help music":
                await message.reply(f"**spooky.wtf - Discord Self-Bot**\n\n> **[!]** Help - Music\n\n`{data['prefix']}makemp3 [.mp4_file]`\n\n-# Created by @ s.eths・v{data['version']}")
            elif message.content == f"{data['prefix']}help roleplay":
            ...
            elif message.content == f"{data['prefix']}help social":
                await message.reply(f"**spooky.wtf - Discord Self-Bot**\n\n> **[!]** Help - Social\n\n`{data['prefix']}gagstock`\n`{data['prefix']}pinterest [pinterest_link]`\n\n-# Created by @ s.eths・v{data['version']}")
            elif message.content == f"{data['prefix']}help text":
